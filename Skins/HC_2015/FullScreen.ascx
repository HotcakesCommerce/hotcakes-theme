...
<!-- HC 2015 Skins | Full Screen Skin | 01.00.00 -->
<style type="text/css">
    .showControlBar .headerMain .siteWidth {
        margin: 54px auto 0;
    }
</style>
<div class="bannerMain bannerMainFull">
    <div class="headerWrap">
        <header>
            <div class="headerMain">
                <div class="siteWidth">
                    <div class="logoMain">
                        <a hr<%=""%>ef="<%= NavigateUrl(PortalSettings.HomeTabId)%>" title="Hotcakes Commerce" id="dnn_dnnLOGO_hypLogo">
                            <img alt="Hotcakes Commerce" src="/Portals/_default/Skins/HC_2015/Images/logo-hotcakes-white-200x67.png" alt="" /></a>
                    </div>
                    <div class="menuMain">
                        <span class="mobileMenuMain visible-xxs visible-xs visible-sm"><a class="dnnTertiaryAction medButton compact margin-0" data-toggle="collapse" data-target="#mobileMenu"><em class="fa fa-navicon"></em><span>&nbsp;Menu</a></span></span>
    ...
    <div class="ContentPane myPane" id="BannerPaneOver" runat="server" visible="false"></div>
</div>
<div class="BGTable HCskins homePage fullPage">
