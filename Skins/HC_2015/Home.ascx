...
<!-- HC 2015 Skins | Home Skin | 01.00.00 -->
<div class="BGTable HCskins homePage">
  <div class="headerWrap">
    <header>
      <div class="headerMain">
        <div class="siteWidth">
          <div class="logoMain">
            <a hr<%=""%>ef="<%= NavigateUrl(PortalSettings.HomeTabId)%>" title="Hotcakes Commerce" id="dnn_dnnLOGO_hypLogo"><img src="/Portals/_default/Skins/HC_2015/Images/logo-hotcakes-white-200x67.png" alt="Hotcakes Commerce: An Open-Source E-Commerce Solution by Upendo Ventures" /></a>
          </div>
          <div class="menuMain"> <span class="mobileMenuMain visible-xxs visible-xs visible-sm"><a class="dnnTertiaryAction medButton compact margin-0" data-toggle="collapse" data-target="#mobileMenu"><em class="fa fa-navicon"></em><span> &nbsp;Menu</a></span></span>
    ...
    <header class="header2">
      <div class="ContentPane myPane" id="TabMenuPane" runat="server" visible="false"></div>
      <div class="headerMain2">
        <div class="siteWidth">
          <div class="logoMain">
            <a hr<%=""%>ef="<%= NavigateUrl(PortalSettings.HomeTabId)%>" title="Hotcakes Commerce" id="dnn_dnnLOGO_hypLogo"><img src="/Portals/_default/Skins/HC_2015/Images/logo-hotcakes-trans-200x67.png" alt="Hotcakes Commerce: An Open-Source E-Commerce Solution by Upendo Ventures" /></a>
          </div>
          <div class="menuMain">
        ...
        <div class="siteWidth">
          <div id="mobileMenu2" class="collapse">
            <div class="mobileMenuInner">
              <dnn:MENU MenuStyle="menus/TWMobMenuCollapse" runat="server" NodeSelector="RootOnly"></dnn:MENU>
              <div class="clearfix"></div>
            </div>
