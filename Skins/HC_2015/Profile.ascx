...
<!-- HC 2015 Skins | Profile Skin | 01.00.00 -->
<div class="BGTable HCskins subPage">
  ...
  <div class="contentMain">
    <div class="siteWidth">
      <div class="col-xs-12 col-md-4 myPane" id="MenuPane" runat="server" visible="false"></div>
      <div class="col-xs-12 col-md-8 myPane" id="ProfilePane" runat="server" visible="false"></div>
    </div>
    <div class="clearfix"></div>
    <div class="siteWidth">
