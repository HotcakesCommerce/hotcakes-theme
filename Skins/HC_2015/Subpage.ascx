...
<!-- HC 2015 Skins | Subpage Skin | 01.00.00 -->
<div class="BGTable HCskins subPage">
  ...
  <div class="contentMain">
    ...
    <div class="ContentPane myPane" id="MainFullPane" runat="server" visible="false"></div>
      <div class="clearfix"></div>
      <div class="col-md-4 myPane" id="ContentPane33Left" runat="server" visible="false"></div>
        <div class="col-md-4 myPane" id="ContentPane33Middle" runat="server" visible="false"></div>
        <div class="col-md-4 myPane" id="ContentPane33Right" runat="server" visible="false"></div>
      <div class="clearfix"></div>
          <div class="col-xxs-12 col-xs-6 myPane" id="ContentPane50Left" runat="server" visible="false"></div>
          <div class="col-xxs-12 col-xs-6 myPane" id="ContentPane50Right" runat="server" visible="false"></div>
      <div class="clearfix"></div>
    <div class="ContentPane myPane" id="MainFullPaneLower" runat="server" visible="false"></div>
      <div class="clearfix"></div>
  </div>
  <footer class="Footer">
